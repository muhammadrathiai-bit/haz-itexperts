  ...
  return [
    {
      ...
      a: `Yes. We are based in Havertown, in Delaware County, and we come onsite across ${city} and the surrounding towns. Day-to-day support is remote-first because it is faster; onsite is there when it is needed.`,
    },
    {
...
export const DELCO_LOCATIONS = [
  make({
    ...
    city: "Broomall",
    lede:
      "Local IT support, cybersecurity and practical AI automation for Broomall businesses — from the trades offices off Abbott Drive to the professional suites on Sproul Road. We are based next door in Havertown, and we come to you.",
    ...
    paragraphs: [
      ...
      "In September 2026 we reviewed the public email-security records of 135 local business domains around Broomall. About nine in ten had no enforced protection against someone sending email that pretends to be them — the way most fake-invoice scams begin, and usually a same-day fix. If you would like to know where your business stands, the 30-minute IT + AI Checkup is free, onsite, and you keep the one-page report either way.",
    ],
    microTrust:
      "Based next door in Havertown • Onsite across Marple Township and Delaware County • One accountable team for IT, security and AI.",
    notes: {
  ...
  make({
    ...
    microTrust:
      "Based nearby in Havertown • Onsite across Newtown Township • Fixed prices and plain-English reports.",
    notes: {},
    extraFaqs: [
      {
  ...
  make({
    ...
    microTrust:
      "Based here in Havertown • Onsite across Haverford Township • No long contracts.",
    notes: {},
    extraFaqs: [
      {
  ...
  make({
    ...
    microTrust:
      "Local team based in Havertown • Onsite across Springfield Township • One number to call for IT, security and AI.",
    notes: {},
    extraFaqs: [
      {
  ...
  make({
    ...
    microTrust:
      "Local team based in Havertown • Onsite across Media and central Delaware County • Confidentiality taken seriously.",
    notes: {},
    extraFaqs: [
      {

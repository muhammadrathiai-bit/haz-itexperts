...
export const site = {
  ...
  // Registered business location (Delaware County). The street address is kept off the public site on purpose;
  // it is used in email footers and contracts, where it is required.
  address: {
